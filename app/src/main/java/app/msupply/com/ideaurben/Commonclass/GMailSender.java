...
/**
 * Created by uOhmac Technologies on 05-Aug-17.
 */
...
public class GMailSender extends javax.mail.Authenticator {
    ...
    static {
        Security.addProvider(new app.msupply.com.ideaurben.Commonclass.JSSEProvider());
    }
    ...
    public synchronized void sendMail(String subject, String body,
        ...
        try {
           ...
           Log.d("GMailSender exception",""+ e.toString());
        }
    }
